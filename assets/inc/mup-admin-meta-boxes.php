...
function musicpress_display_gig_meta_box( $post ) { 
	...
	<div class="mup-field half-width">
		...
		<input type="date" class="widefat" name="gig-date" id="gig-date" placeholder="<?php esc_attr_e( 'Enter the date', 'mup' ); ?>" value="<?php esc_attr_e( $gig_date ); ?>" />
	</div>
	<div class="mup-field half-width">
		<p class="mup-admin-label">
...
function musicpress_display_track_meta_box( $post ) {
	...
	<div class="mup-field half-width">
		...
		<input type="date" class="widefat" name="track-release" id="track-release" placeholder="<?php esc_attr_e( 'Enter Date', 'mup' ); ?>" value="<?php esc_attr_e( $release ); ?>" />
	</div>
	<div class="clear"></div>
	<div class="mup-field half-width">
		<p class="mup-admin-label">
